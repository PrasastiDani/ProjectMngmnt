<!-- Main modal -->
<div id="crud-income" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <!-- Modal body -->
            <form action="{{ route('income.store') }}" method="POST" class="p-4 md:-5">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="date" class="block mb-2 text-sm font-medium text-gray-900">Tanggal</label>
                        <input type="date" name="date" id="date"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-500"
                            required>
                    </div>
                    <div class="col-span-2">
                ...
                <div class="flex flex-row-reverse gap-2">
                    <button type="button" data-modal-hide="crud-income"
